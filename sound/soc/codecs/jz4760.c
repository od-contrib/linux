...
static const struct snd_soc_dapm_widget jz4760_codec_dapm_widgets[] = {
	...
	SND_SOC_DAPM_PGA("Line Out", JZ4760_CODEC_REG_PMR2,
			 REG_PMR2_SB_LOUT_OFFSET, 1, NULL, 0),

	SND_SOC_DAPM_PGA("Line Out Mute", JZ4760_CODEC_REG_CR1,
			 REG_CR1_LO_MUTE_OFFSET, 1, NULL, 0),

	SND_SOC_DAPM_PGA("BTL Out", JZ4760_CODEC_REG_PMR2,
			 REG_PMR2_SB_BTL_OFFSET, 1, NULL, 0),

	SND_SOC_DAPM_PGA("BTL Out Mute", JZ4760_CODEC_REG_CR1,
			 REG_CR1_BTL_MUTE_OFFSET, 1, NULL, 0),
	...
	SND_SOC_DAPM_ADC_E("ADC", "HiFi Capture", JZ4760_CODEC_REG_PMR2,
			   REG_PMR2_SB_ADC_OFFSET, 1, adc_poweron_event,
			   SND_SOC_DAPM_POST_PMU),

	SND_SOC_DAPM_DAC("DAC", "HiFi Playback", JZ4760_CODEC_REG_PMR2,
...
static const struct snd_soc_dapm_route jz4760_codec_dapm_routes[] = {
	...
	{ "Line Out Mute", NULL, "HP Out" },
	{ "Line Out", NULL, "Line Out Mute" },
	{ "BTL Out Mute", NULL, "Line Out" },
	{ "BTL Out", NULL, "BTL Out Mute" },
