...
static const struct reg_sequence y030xx067a_init_sequence[] = {
	...
	{ 0x0e, REG0E_CONTRAST_B(0x10) | REG0E_PIXELCOLORDRIVE },
	{ 0x0f, 0 },
...
static const struct y030xx067a_info y030xx067a_info = {
	...
	.height_mm = 51,
	/*
	 * The pixel order on the bus really seems to be RGB, but using sane
	 * timings the rightmost blue subpixel column does not light up.
	 * To counter this, we treat the panel as GBR and offset the horizontal
	 * position by one subpixel.
	 */
	.bus_format = MEDIA_BUS_FMT_GBR888_3X8,
