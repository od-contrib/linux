...
#define REG00_YCBCR			BIT(7)

#define REG03_BRIGHTNESS		(val)

#define REG04_SEL			((val) << 4)
#define REG04_VDIR			BIT(1)
#define REG04_HDIR			BIT(0)

#define REG05_GRB			BIT(6)
#define REG05_PFM_DUTY			((val) << 3)
#define REG05_SHDB2			BIT(2)
#define REG05_SHDB1			BIT(1)
#define REG05_STB			BIT(0)

#define REG06_HBLK_EN			BIT(7)
#define REG06_LED_CURRENT		((val) << 5)
#define REG06_VBLK			(val)

#define REG07_HBLK			(val)

#define REG08_BL_DRV			((val) << 6)
#define REG08_DRV_FREQ			((val) << 4)

#define REG12_CBCR			BIT(4)
#define REG12_VDPOL			BIT(2)
#define REG12_HDPOL			BIT(1)
#define REG12_DCLKPOL			BIT(0)

#define REG13_CONTRAST_RGB		(val)

#define REG14_SUB_CONTRAST_R		(val)

#define REG15_SUB_BRIGHT_R		(val)

#define REG16_SUB_CONTRAST_B		(val)

#define REG17_SUB_BRIGHT_B		(val)

#define REG21_LED_ON_CYCLE		((val) << 5)
#define REG21_LED_ON_RATIO		(val)

#define REG27_VCOM_SEL			BIT(7)
#define REG27_VCOMH			(val)

#define REG28_VCOML			(val)
