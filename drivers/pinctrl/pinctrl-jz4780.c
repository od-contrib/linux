...
static int jz4780_pinmux_enable(struct pinctrl_dev *pctldev, unsigned selector,
				unsigned group)
{
	struct jz4780_pinctrl *jzpc = pinctrl_dev_get_drvdata(pctldev);
...
static void jz4780_pinmux_disable(struct pinctrl_dev *pctldev,
...
static struct pinmux_ops jz4780_pmxops = {
	...
	.enable = jz4780_pinmux_enable,
	.disable = jz4780_pinmux_disable,
