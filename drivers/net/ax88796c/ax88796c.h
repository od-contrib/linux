...
#define AX88796C_DRV_VERSION	"1.4.0"
...
#else
#define TX_QUEUE_HIGH_WATER		1		/* Tx queue high water mark */
#define TX_QUEUE_LOW_WATER		1		/* Tx queue low water mark */
#endif
...
#define P0_WFCR		AX_SHIFT(0x0A)
	...
	#define WFCR_PMEPULSE2MS	(0x00 << 6)
	#define WFCR_PMEPULSE8MS	(0x01 << 6)
	#define WFCR_PMEPULSE32MS	(0x02 << 6)
	#define WFCR_PMEPULSE64MS	(0x03 << 6)
