 ...
 *
 * JZ4780 hlba1 board lcd setup routines.
 *
...
static int hlba1_backlight_init(struct device *dev)
{
	return 0;
}

static void hlba1_backlight_exit(struct device *dev)
{
}

static struct platform_pwm_backlight_data hlba1_backlight_data = {
	.pwm_id		= 0,
	.max_brightness	= 255,
	.dft_brightness	= 80,
	.pwm_period_ns	= 10000, /* 100 kHZ */
	.init		= hlba1_backlight_init,
	.exit		= hlba1_backlight_exit,
};

/* Backlight Device */
struct platform_device hlba1_backlight_device = {
	.name		= "pwm-backlight",
	.dev		= {
		.platform_data	= &hlba1_backlight_data,
	},
};
