...
struct mmc_partition_info hlba1_inand_partition_info[] = {
...
static struct mmc_recovery_info hlba1_inand_recovery_info = {
	.partition_info			= hlba1_inand_partition_info,
	.partition_num			= ARRAY_SIZE(hlba1_inand_partition_info),
	.permission			= MMC_BOOT_AREA_PROTECTED,
	.protect_boundary		= 21*MBYTE,
};
	
struct jzmmc_platform_data hlba1_inand_pdata = {
	.removal  			= DONTCARE,
	.sdio_clk			= 0,
	...
	.recovery_info			= &hlba1_inand_recovery_info,
	.gpio				= NULL,
...
struct jzmmc_platform_data hlba1_sdio_pdata = {
	.removal  			= MANUAL,
	.sdio_clk			= 1,
	.ocr_avail			= MMC_VDD_32_33 | MMC_VDD_33_34,
