...
static struct jz_battery_platform_data hlba1_battery_pdata = {
	.info = {
		.max_vol        = 4050,
		.min_vol        = 3600,
		.usb_max_vol    = 4100,
...
#define IR_POWER    0x01
#define IR_HOME     0x0d
#define IR_MENU     0x0c
#define IR_BACK     0x0e

#define IR_VOLUMEUP 		(0x19)
#define IR_VOLUMEDOWN   (0x18)

#define IR_UP       0x05
#define IR_DOWN     0x0a
#define IR_LEFT     0x06
#define IR_RIGHT    0x08
#define IR_OK       0x09

#define IR_HELP     		0x86
#define IR_SEARCH   		0x94

#define IR_NEXTSONG 		0x81
#define IR_PREVIOUSSONG 0x93
#define IR_PLAY     		0x85
#define IR_PLAYPAUSE    0x89
...
static int __init hlba1_board_init(void)
{
...
/* mmc */
	...
	jz_device_register(&jz_msc0_device, &hlba1_tf_pdata);
#endif
#ifdef CONFIG_MMC1_JZ4780
	jz_device_register(&jz_msc1_device, &hlba1_sdio_pdata);
#endif
#ifdef CONFIG_MMC2_JZ4780
	jz_device_register(&jz_msc2_device, &hlba1_tf_pdata);
#endif
/* i2c */
...
/* panel and bl */
	...
	platform_device_register(&hlba1_backlight_device);
#endif
...
/* ADC*/
#ifdef CONFIG_BATTERY_JZ4780
	jz_device_register(&jz_adc_device, &hlba1_battery_pdata);
#endif
/* efuse */
...
arch_initcall(hlba1_board_init);
static struct wake_lock keep_alive_lock;
static int __init hdmi_hlba1_board_lateinit(void)
{
...
late_initcall(hdmi_hlba1_board_lateinit);