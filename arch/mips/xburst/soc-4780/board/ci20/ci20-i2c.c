...
static struct jztsc_pin ci20_tsc_gpio[] = {
	[0] = {GPIO_CTP_IRQ,		HIGH_ENABLE},
	[1] = {GPIO_CTP_WAKE_UP,	HIGH_ENABLE},
};
#endif

static struct jztsc_platform_data ci20_tsc_pdata = {
	.gpio		= ci20_tsc_gpio,
	.x_max		= 1024,
	.y_max		= 600,
};
...
static struct i2c_board_info ci20_i2c1_devs[] __initdata = {
#if 0
...
static struct i2c_board_info ci20_i2c3_devs[] __initdata = {
#ifdef CONFIG_TOUCHSCREEN_LDWZIC
	{
		I2C_BOARD_INFO("ldwzic_ts", 0x01),
		.platform_data	= &ci20_tsc_pdata,
	},
#endif
...
static int __init ci20_i2c_dev_init(void)
{
...
#if (defined(CONFIG_I2C3_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(3, ci20_i2c3_devs, ARRAY_SIZE(ci20_i2c3_devs));
#endif
	return 0;
}

arch_initcall(ci20_i2c_dev_init);
