...
#define SIZE_NAND	(8ull * SZ_GB)

#define START_UBOOT	0ull
#define SIZE_UBOOT	(12ull * SZ_MB)
...
#define NAND_FLASH_MT29F64G08CBAAAWP_NAME    "MT29F64G08CBAAAWP"
#define NAND_FLASH_MT29F64G08CBAAAWP_ID      0x88

static nand_flash_info_t board_support_nand_info_adjust_table[] = {
	{
		COMMON_NAND_CHIP_INFO(
			NAND_FLASH_MT29F64G08CBAAAWP_NAME,
			NAND_MFR_MICRON, NAND_FLASH_MT29F64G08CBAAAWP_ID,
			1024, 24, 0,
