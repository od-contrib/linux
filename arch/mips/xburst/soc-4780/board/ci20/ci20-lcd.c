 ...
 *
 * JZ4780 ci20 board lcd setup routines.
 *
...
static int ci20_backlight_init(struct device *dev)
{
	return 0;
}

static void ci20_backlight_exit(struct device *dev)
{
}

static struct platform_pwm_backlight_data ci20_backlight_data = {
	.pwm_id		= 0,
	.max_brightness	= 255,
	.dft_brightness	= 80,
	.pwm_period_ns	= 10000, /* 100 kHZ */
	.init		= ci20_backlight_init,
	.exit		= ci20_backlight_exit,
};

/* Backlight Device */
struct platform_device ci20_backlight_device = {
	.name		= "pwm-backlight",
	.dev		= {
		.platform_data	= &ci20_backlight_data,
	},
};
