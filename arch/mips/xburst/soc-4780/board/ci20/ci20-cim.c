...
extern struct i2c_board_info ci20_i2c2_devs_v4l2[];

#ifdef CONFIG_VIDEO_JZ4780_CIM_HOST
struct jz4780_camera_pdata ci20_camera_pdata = {
	.mclk_10khz = 2400,
	.flags = 0,
...
static struct soc_camera_link iclink_front = {
	...
	.board_info	= &ci20_i2c2_devs_v4l2[FRONT_CAMERA_INDEX],
	.i2c_adapter_id	= 2,
	.power = front_camera_sensor_power,
	.reset = camera_sensor_reset,
};

struct platform_device ci20_front_camera_sensor = {
...
static int __init ci20_board_cim_init(void) {
	/* camera host */
#ifdef CONFIG_VIDEO_JZ4780_CIM_HOST
	jz_device_register(&jz_cim_device, &ci20_camera_pdata);
#endif
	/* camera sensor */
#ifdef CONFIG_FRONT_CAMERA
	platform_device_register(&ci20_front_camera_sensor);
#endif

	return 0;
}

arch_initcall(ci20_board_cim_init);
