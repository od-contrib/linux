...
static struct jztsc_pin ebook_tsc_gpio[] = {
...
static struct i2c_board_info ebook_i2c2_devs[] __initdata = {
#ifdef CONFIG_SP0838
	{
...
static int __init ebook_i2c_dev_init(void)
{
...
#if (defined(CONFIG_I2C1_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(1, ebook_i2c1_devs, ARRAY_SIZE(ebook_i2c1_devs));
#endif
...
#if (defined(CONFIG_I2C3_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(3, ebook_i2c3_devs, ARRAY_SIZE(ebook_i2c3_devs));
#endif
	return 0;
}

arch_initcall(ebook_i2c_dev_init);
