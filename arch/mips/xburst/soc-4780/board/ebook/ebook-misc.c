...
static struct jz_battery_platform_data ebook_battery_pdata = {
	.info = {
		.max_vol        = 4080,
		.min_vol        = 3600,
		.usb_max_vol    = 4150,
...
/* mmc */
	...
	jz_device_register(&jz_msc0_device, &ebook_inand_pdata);
#endif
#ifdef CONFIG_MMC1_JZ4780
	jz_device_register(&jz_msc1_device, &ebook_sdio_pdata);
#endif
#ifdef CONFIG_MMC2_JZ4780
	jz_device_register(&jz_msc2_device, &ebook_tf_pdata);
#endif
#else
#ifdef CONFIG_MMC0_JZ4780
	jz_device_register(&jz_msc0_device, &ebook_tf_pdata);
#endif
#ifdef CONFIG_MMC1_JZ4780
	jz_device_register(&jz_msc1_device, &ebook_sdio_pdata);
#endif
...
/* panel and bl */
	...
	platform_device_register(&ebook_backlight_device);
#endif
/* lcdc framebuffer*/
...
/* ADC*/
#ifdef CONFIG_BATTERY_JZ4780
	jz_device_register(&jz_adc_device, &ebook_battery_pdata);
#endif
/* uart */
...
arch_initcall(ebook_board_init);
