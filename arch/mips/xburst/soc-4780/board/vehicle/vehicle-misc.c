...
/* LCD Panel Device */
extern struct platform_device at065tn14_device;
...
static int __init vehicle_board_init(void)
{
...
/* mmc */
	...
	jz_device_register(&jz_msc1_device, &vehicle_sdio_pdata);
#endif
#ifdef CONFIG_MMC2_JZ4780
	jz_device_register(&jz_msc2_device, &vehicle_tf_pdata);
#endif
#else
#ifdef CONFIG_MMC0_JZ4780
	jz_device_register(&jz_msc0_device, &vehicle_tf_pdata);
#endif
#ifdef CONFIG_MMC1_JZ4780
	jz_device_register(&jz_msc1_device, &vehicle_sdio_pdata);
#endif
...
#ifdef CONFIG_LCD_AT065TN14
	platform_device_register(&at065tn14_device);
#endif

#ifdef CONFIG_BACKLIGHT_PWM
	platform_device_register(&vehicle_backlight_device);
#endif
/* lcdc framebuffer*/
...
arch_initcall(vehicle_board_init);
