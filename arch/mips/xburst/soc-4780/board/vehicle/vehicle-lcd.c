 ...
 *
 * JZ4780 vehicle board lcd setup routines.
 *
...
static struct platform_tm080tdh01_data tm080tdh01_pdata= {
/* gpio had been hardware control */
};

/* LCD Panel Device */
struct platform_device tm080tdh01_device = {
	.name		= "tm080tdh01-lcd",
	.dev		= {
		.platform_data	= &tm080tdh01_pdata,
	},
};
#endif
...
static struct platform_at065tn14_data at065tn14_pdata= {
	.gpio_de = GPIO_PC(9),
	.gpio_vs = GPIO_PC(19),
	.gpio_hs = GPIO_PC(18),
...
/* LCD Panel Device */
struct platform_device at065tn14_device = {
	.name		= "at065tn14-lcd",
	.dev		= {
		.platform_data	= &at065tn14_pdata,
	},
};
#endif
...
static int vehicle_backlight_init(struct device *dev)
{
	return 0;
}

static void vehicle_backlight_exit(struct device *dev)
{
}

static struct platform_pwm_backlight_data vehicle_backlight_data = {
	.pwm_id		= 0,
	.max_brightness	= 255,
	.dft_brightness	= 80,
	.pwm_period_ns	= 5000000, /* 5000 kHZ */
	.init		= vehicle_backlight_init,
	.exit		= vehicle_backlight_exit,
};

/* Backlight Device */
struct platform_device vehicle_backlight_device = {
	.name		= "pwm-backlight",
	.dev		= {
		.platform_data	= &vehicle_backlight_data,
	},
};
