...
static struct jztsc_pin vehicle_tsc_gpio[] = {
	[0] = {GPIO_CTP_IRQ,		HIGH_ENABLE},
	[1] = {GPIO_CTP_WAKE_UP,	HIGH_ENABLE},
};

static struct jztsc_platform_data vehicle_tsc_pdata = {
	.gpio		= vehicle_tsc_gpio,
	.x_max		= 1024,
	.y_max		= 768,
};
#endif
...
static struct i2c_board_info vehicle_i2c1_devs[] __initdata = {
...
static struct i2c_board_info vehicle_i2c2_devs[] __initdata = {
#ifdef CONFIG_SP0838
	{
...
static struct i2c_board_info vehicle_i2c3_devs[] __initdata = {
#ifdef CONFIG_TOUCHSCREEN_LDWZIC
	{
		I2C_BOARD_INFO("ldwzic_ts", 0x01),
		.platform_data	= &vehicle_tsc_pdata,
	},
#endif
...
static int __init vehicle_i2c_dev_init(void)
{
...
#if (defined(CONFIG_I2C1_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(1, vehicle_i2c1_devs, ARRAY_SIZE(vehicle_i2c1_devs));
#endif

#if (defined(CONFIG_I2C_GPIO) || defined(CONFIG_I2C2_JZ4780))
	i2c_register_board_info(2, vehicle_i2c2_devs, ARRAY_SIZE(vehicle_i2c2_devs));
#endif

#if (defined(CONFIG_I2C3_JZ4780) || defined(CONFIG_I2C_GPIO))
	i2c_register_board_info(3, vehicle_i2c3_devs, ARRAY_SIZE(vehicle_i2c3_devs));
#endif
	return 0;
}

arch_initcall(vehicle_i2c_dev_init);
