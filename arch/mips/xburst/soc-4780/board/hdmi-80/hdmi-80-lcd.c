 ...
 *
 * JZ4780 hdmi_80 board lcd setup routines.
 *
...
static int hdmi_80_backlight_init(struct device *dev)
{
	return 0;
}

static void hdmi_80_backlight_exit(struct device *dev)
{
}

static struct platform_pwm_backlight_data hdmi_80_backlight_data = {
	.pwm_id		= 0,
	.max_brightness	= 255,
	.dft_brightness	= 80,
	.pwm_period_ns	= 10000, /* 100 kHZ */
	.init		= hdmi_80_backlight_init,
	.exit		= hdmi_80_backlight_exit,
};

/* Backlight Device */
struct platform_device hdmi_80_backlight_device = {
	.name		= "pwm-backlight",
	.dev		= {
		.platform_data	= &hdmi_80_backlight_data,
	},
};
