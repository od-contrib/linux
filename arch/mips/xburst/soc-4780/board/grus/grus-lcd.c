 ...
 *
 * JZ4780 grus board lcd setup routines.
 *
...
static int grus_backlight_init(struct device *dev)
{
	return 0;
}

static void grus_backlight_exit(struct device *dev)
{
}

static struct platform_pwm_backlight_data grus_backlight_data = {
	.pwm_id		= 0,
	.max_brightness	= 255,
	.dft_brightness	= 80,
	.pwm_period_ns	= 10000, /* 100 kHZ */
	.init		= grus_backlight_init,
	.exit		= grus_backlight_exit,
};
...
struct platform_device grus_backlight_device = {
	.name		= "pwm-backlight",
	.dev		= {
		.platform_data	= &grus_backlight_data,
	},
};
