...
/* 65 */
#define HDMI_800X600_P_60HZ_4X3					\
	{"800x600-p-60hz-4:3",					\
			60, 800, 600, KHZ2PICOS(40000), 88, 40,	\
			23, 1, 128, 4,					\
			FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,	\
			FB_VMODE_NONINTERLACED, 65}

/* 66 */
#define HDMI_1024X768_P_60HZ_4X3					\
	{"1024x768-p-60hz-4:3",						\
			60, 1024, 768,KHZ2PICOS(65000), 160, 24,		\
			29, 3 , 136 , 6,					\
			FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,	\
			FB_VMODE_NONINTERLACED, 66}
...
#define DEFAULT_HDMI_VIDEO_MODE_LIST					\
	...
	ADD_HDMI_VIDEO_MODE(HDMI_1280X720_P_120HZ_16X9), /* 47 */	\
	ADD_HDMI_VIDEO_MODE(HDMI_1280X720_P_25HZ_16X9), /* 61 */	\
	ADD_HDMI_VIDEO_MODE(HDMI_800X600_P_60HZ_4X3), /* 65 */		\
	ADD_HDMI_VIDEO_MODE(HDMI_1024X768_P_60HZ_4X3), /* 66 */		\
	ADD_HDMI_VIDEO_MODE(HDMI_1280X720_P_30HZ_16X9) /* 62 */
#endif
